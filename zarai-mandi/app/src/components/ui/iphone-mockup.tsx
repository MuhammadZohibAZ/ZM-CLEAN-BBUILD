...
type IPhoneModel = '14' | '14-pro' | '15' | '15-pro' | '15-pro-max' | 'x' | 'plain';
...
export interface IPhoneMockupProps {
  ...
  /** Home indicator colour; the default light bar suits dark screens. */
...
export const DEVICE_SPECS: Record<IPhoneModel, {
  ...
  // iPhone 15 Pro Max
  '15-pro-max': {
    w: 430, h: 932, radius: 58, bezel: 12,
    topSafe: 59, bottomSafe: 34,
    island: { w: 126, h: 37, r: 20 }
  },
